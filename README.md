...
The Maven artifact coordinates (`com.google.cloud:google-cloud-bigquerymigration`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-bigquerymigration:0.10.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-bigquerymigration" % "0.10.0"
```
